      ...
      <BackButton />
        ...
        <div className='flex flex-col border-2 border-sky-400 rounded-xl w-[600px] p-4 mx-auto'>
          <div className='my-4'>
            ...
            <input type="number" value={publishedYear} onChange={(e) => setPublishedYear(e.target.value)} className='border-2 border-gray-500 px-4 py-2 w-full'/>
            
            <button className='p-2 bg-sky-300 m-8' onClick={handleEditBook}>Update</button>
            <Link to={'/'}><button className='p-2 bg-gray-300 m-8' >Cancle</button></Link>
          </div>
        </div>
    </div>
  )
